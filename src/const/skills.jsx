export const skills = [
  ...
  {
    name: 'React',
    text: `Used React for this page, and also for projects at BlackCat and Bite the Ballot. It's by far my favourite front end framework!`,
    key: 4
  },
  {
    name: 'AngularJS',
  ...
  {
    name: 'Redux',
    text: `Used for global state management on a project at BlackCat. I have some qualms about it, but I'm sure it can be pleasant when used right`,
    key: 6
  },
  {
    name: 'GraphQL',
    text: `Used at Bite The Ballot. It's a little weird at first, but it's so intuitive! I love the idea behind it`,
    key: 7
  },
  {
    name: 'Java',
  ...
  {
    name: 'Spring MVC',
    text: `Used on a project at BlackCat, providing the HTTP backend for
                a web app. It kinda does everything!`,
    key: 9
  },
  {
    name: 'Dropwizard',
  ...
  {
    name: 'Hibernate',
    text: `Used as the ORM for several projects at BlackCat. It's a powerful
