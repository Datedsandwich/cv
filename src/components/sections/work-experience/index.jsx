      ...
      experiences: [
        {
          ...
          body:
            'Worked on a Fixed Asset Management Suite, using Java (and Dropwizard) for the ba' +
        ...
        },
        {
          ...
          body:
            'Working on Bip, written in C# using the Unity engine, and myself and the Technic' +
